...
const permissions = [
  ...
  {
    code: "payroll.tax_profile.view",
    name: "View employee tax profiles and TD1",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_profile.manage",
    name: "Edit employee tax profiles and TD1",
    moduleKey: "payroll",
  },
  {
    code: "payroll.prior_employment.manage",
    name: "Enter prior-employer YTD records",
    moduleKey: "payroll",
  },
  {
    code: "payroll.prior_employment.verify",
    name: "Verify prior-employer YTD records",
    moduleKey: "payroll",
  },
  {
    code: "payroll.statutory_override.request",
    name: "Request period statutory amount overrides",
    moduleKey: "payroll",
  },
  {
    code: "payroll.statutory_override.approve",
    name: "Approve period statutory amount overrides",
    moduleKey: "payroll",
  },
  {
    code: "payroll.employee_year.view",
    name: "View employee payroll tax-year ledger",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_projection.view",
    name: "View employee annual PAYE projection",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_projection.preview",
    name: "Preview employee annual PAYE projection",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_projection.approve",
    name: "Approve employee annual PAYE projection",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_projection.apply",
    name: "Apply approved PAYE projection to payroll",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_adjustments.create",
    name: "Create employee tax-year adjustments",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_adjustments.approve",
    name: "Approve employee tax-year adjustments",
    moduleKey: "payroll",
  },
  {
    code: "payroll.tax_treatment.override",
    name: "Override employee earning tax treatment",
    moduleKey: "payroll",
  },
  {
  ...
  {
    code: "payroll.payment_instructions.import",
    name: "Import employee payment instructions (bulk)",
    moduleKey: "payroll",
  },
  {
    code: "payroll.payment_batches.prepare",
    name: "Prepare and validate bank payment batches",
    moduleKey: "payroll",
  },
  {
    code: "payroll.payment_batches.approve",
    name: "Approve bank payment batches (checker)",
    moduleKey: "payroll",
  },
  {
    code: "payroll.payment_batches.export",
    name: "Export approved bank payment batches",
    moduleKey: "payroll",
  },
  {
    code: "documents.view",
...
const roleTemplates: RoleTemplate[] = [
  ...
  {
    code: "BANK_EXPORT_OFFICER",
    name: "Bank Export Officer",
    description:
      "Export approved payroll bank payment batches and view masked payment readiness. Cannot approve batches they prepare (maker-checker).",
    permissionCodes: [
      ...selfServicePermissionCodes,
      "people.directory.view",
      "payroll.view",
