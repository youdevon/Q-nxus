...
export function JobDescriptionForm({
  ...
  function updateRow(
    rowId: string,
    values: Partial<CriterionRow>,
  ) {
    setRows((current) =>
      current.map((row) =>
        row.rowId === rowId ? { ...row, ...values } : row,
      ),
    )
  }
        ...
        <div className="grid gap-5 border-y border-border py-6 md:grid-cols-2">
          <div className="md:col-span-2">
            ...
            <Input
              name="title"
              defaultValue={
                jobDescription?.title ?? position.title
              }
              className="mt-2"
              required
            />
          ...
          <div className="md:col-span-2">
            ...
            <Textarea
              ...
              defaultValue={
                jobDescription?.positionPurpose ?? ""
              }
              rows={4}
              className="mt-2"
            />
          ...
          <div>
            ...
            <Input
              ...
              defaultValue={
                jobDescription?.supervisoryResponsibility ?? ""
              }
              className="mt-2"
            />
          </div>
